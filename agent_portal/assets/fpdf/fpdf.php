...
function Output($name='', $dest='')
{
	...
	switch($dest)
	{
		case 'I':
			...
			if(ob_get_length())
				$this->Error('Some data has already been output, can\'t send PDF file A');
			if(php_sapi_name()!='cli')
			{
				//We send to a browser
				header('Content-Type: application/pdf');
				if(headers_sent())
					$this->Error('Some data has already been output, can\'t send PDF file B');
		...
		case 'D':
			//Download file
			if(ob_get_length())
				$this->Error('Some data has already been output, can\'t send PDF file C');
			header('Content-Type: application/x-download');
			if(headers_sent())
				$this->Error('Some data has already been output, can\'t send PDF file D');
			header('Content-Length: '.strlen($this->buffer));
