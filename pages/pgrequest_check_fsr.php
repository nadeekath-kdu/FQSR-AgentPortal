...
if ((isset($_GET['idn'])) && ($_GET['idn'] != NULL) && ($_GET['idn'] != "") && ($_GET['idn'] != " ")) {
	...
	// Optionally: display or use $amount in the UI
	// Example: echo "<div>Total Amount: $amount USD</div>";
							...
							<div class="card-body">
								...
								<div class="frame">
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<td><select class="form-control" name="payer_relationship" editable="false" required="true">
